...
func FindNormalizedFold(source string, targets map[string]string) []string {
	return find(source, targets, normalizedFoldTransformer())
}

func find(source string, targets map[string]string, transformer transform.Transformer) []string {
	var matches []string
